...
def newbt(client,callback_query):
    ...
    if txt=="about":
        callback_query.message.edit(text=f"`Channel` : [HellBot](t.me/Hellbot_official)\n`Creator :` [HellBoy](t.me/Kraken_The_Badass)\n`Plugins :` [Sawan](t.me/pyforub)\n`Language :` [Python3](https://python.org)\n`Library :` [Pyrogram](https://docs.pyrogram.org/) \n`Server  :` [Heroku](https://herokuapp.com/)",
                        disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("Extra Plugins", url="t.me/pyforub")]]))
    elif txt=="src":
        callback_query.message.edit(text="Enjoy...:-D\nhttps://github.com/sawanhh/truecaller", disable_web_page_preview=True)
...
def about(client, message):
    client.send_message(chat_id=message.chat.id, reply_to_message_id=message.message_id,
                        text=f"`Channel` : [Hellbot](t.me/Hellbot_official)\n`Creator :` [HellBoy](t.me/kraken_the_badass)\n`Plugins :` [Sawan](t.me/pyforub)\n`Language :` [Python3](https://python.org)\n`Library :` [Pyrogram](https://docs.pyrogram.org/) \n`Server  :` [Heroku](https://herokuapp.com/)",
                        disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("Extra Plugins", url="t.me/pyforub")]]))
...
def echo(client, message):
    ...
    global pq
    pq = ""
    pro = client.send_message(chat_id=message.chat.id, text="", reply_to_message_id=message.message_id)
    r_num = message.text
